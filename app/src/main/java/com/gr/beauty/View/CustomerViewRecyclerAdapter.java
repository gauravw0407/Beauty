...
public class CustomerViewRecyclerAdapter extends RecyclerView.Adapter<CustomerViewRecyclerAdapter.CustomerViewRecyclerViewHolder> {

    ArrayList<CustomerViewDetails> customerViewDetailses;
    long cMobileNo;

    public CustomerViewRecyclerAdapter(long cMobileNo, ArrayList<CustomerViewDetails> customerViewDetailses)
    {
    ...
    @Override
    public CustomerViewRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.customer_view_recyclerview_item,parent,false);
        CustomerViewRecyclerViewHolder customerViewRecyclerViewHolder = new CustomerViewRecyclerViewHolder(view);
        return customerViewRecyclerViewHolder;
    }

    @Override
    public void onBindViewHolder(CustomerViewRecyclerViewHolder holder, int position) {
    ...
    public class CustomerViewRecyclerViewHolder extends RecyclerView.ViewHolder
    {
        TextView shopName, cityName, areaName;

        public CustomerViewRecyclerViewHolder(final View view)
        {
            super(view);
